...
class BatchRLAlgorithm(BaseRLAlgorithm, metaclass=abc.ABCMeta):
    def __init__(
        ...
        self.env_name=env_name #wch add
    ...
    def _train(self):
        ...
        for epoch in gt.timed_for(
            ...
            for _ in range(self.num_train_loops_per_epoch):
                ...
                if not os.path.exists(f'weights/{self.env_name}'):
                    os.makedirs(f'weights/{self.env_name}')
                torch.save(self.trainer.qf1.state_dict(),f'weights/{self.env_name}/qf1.pth')
                torch.save(self.trainer.qf2.state_dict(),f'weights/{self.env_name}/qf2.pth')
                torch.save(self.trainer.policy.state_dict(),f'weights/{self.env_name}/policy.pth')
